...
*/
	...
	this.insertFile = function(colName, fileObject, callback){		
		...
		validationCheck(self.database, self.collections, colName, function(err){
			...
			// Create gridstore
			var gridStore = new GridStore(this.db, new ObjectID(fileObject.id), fileObject.name, "w", options);
	...
	this.queryFileByID = function(colName, id, callback){
		...
		validationCheck(self.database, self.collections, colName, function(err){
			...
			// Create gridstore
			var gridStore = new GridStore(this.db, new ObjectID(id), "r", {root:colName});
			gridStore.open(function(err, gridStore) {
				if(err) return callback(err, null);
